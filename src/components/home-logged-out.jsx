...
const LoggedOutHome = () => {
  ...
  return (
    <div className=" relative text-gray-300 bg-cover bg-homepage-logged-out-image px-2 md:px-28 p-2 md:py-10 flex flex-1 flex-col">
      <div className="px-2 md:px-none  flex flex-col w-full md:w-auto md:items-start items-center absolute left-1/2 md:left-28  top-1/2 -translate-x-1/2 md:translate-x-0 -translate-y-1/2 space-y-6 md:space-y-2">
